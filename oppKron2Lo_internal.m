classdef oppKron2Lo_internal < oppSpot
    %oppKron2Lo_internal  kronecker tensor product to act on a distributed vector.
    %
    %   oppKron2Lo_internal(A,B, gather)A and B are Spot operators or numeric 
    ...
    %
    %   *Now oppKron2Lo_internal also supports local x vectors and distributes them
    %   before calculation( this distribution will be faster than using 
    %   matlabs (:) function).
    %
    %   See also: oppKron2Lo_internal.drandn, oppKron2Lo_internal.rrandn, oppKron2Lo_internal.dzeros,
    %   oppKron2Lo_internal.rzeros
    ...
    methods
        ...
        % Constructor
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function op = oppKron2Lo_internal(varargin)
        ...
        function y = double(op, enable)
            if nargin < 2 || ~enable
                error(['oppKron2Lo_internal is intended for large applications.' ...
    ...
    methods ( Access = protected )
        ...
        function y = multiply(op,x,mode)
            ...
            % Check for op and  x
            assert(isa(op,'oppKron2Lo_internal'),'Left multiplication not taken in account')
