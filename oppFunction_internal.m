classdef oppFunction_internal < oppSpot
%OPPFUNCTION   Wrapper for functions.
%
%   oppFunction_internal(M,N,FUN,CFLAG,LINFLAG) creates a wrapper for function
...
%   http://www.cs.ubc.ca/labs/scl/spot
    ...
    methods
        ...
        % Constructor
        function op = oppFunction_internal(m,n,funhandle,cflag,linflag)
           if nargin < 3
