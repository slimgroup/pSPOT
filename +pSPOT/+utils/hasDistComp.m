function y = hasDistComp()
%HASDISTCOMP Returns true if distcomp toolbox is available
%   Detailed explanation goes here

% y = license('checkout', 'Distrib_Computing_Toolbox');

v = ver;
[inst{1:length(v)}] = deal(v.Name);

y = ismember('Parallel Computing Toolbox', inst) && ...
