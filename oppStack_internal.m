classdef oppStack_internal < oppSpot
    %OPPSTACK  Stack of vertically concatenated operators in parallel
    %
    %   S = oppStack_internal([WEIGHTS], OP1, OP2, ...OPn,GATHER) creates a stacked 
    ...
    %
    %   S = oppStack_internal(N,OP) creates a stacked operator A using N number of
    ...
    %
    %   *Note - only spot operators can be used in an oppStack_internal, pSpot
    ...
    methods
        ...
        % Constructor
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function op = oppStack_internal(varargin)
        ...
        function y = double(op)
            %OPPSTACK.DOUBLE Distributed doubling of oppStack_internal
            %    A = double(op) will apply double to each child operator
            %    in oppStack_internal, and return a distributed stack of explicit
            %    operators.
