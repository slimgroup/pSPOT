classdef oppBlockDiag_internal < oppSpot
    %OPPBLOCKDIAG   Operator-diagonal operator in parallel.
    %
    %   B = oppBlockDiag_internal(OP1, OP2,...,OPN,GATHER) creates a compound
    ...
    %
    %   B = oppBlockDiag_internal([WEIGHT],OP1,...,OPN,GATHER) additionally
    ...
    %
    %   B = oppBlockDiag_internal(N,OP,GATHER) similar as above with WEIGHT
    ...
    methods
        ...
        % Constructor
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function op = oppBlockDiag_internal(varargin)
