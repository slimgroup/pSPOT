classdef oppDictionary_internal < oppSpot
    %OPPDICTIONARY  Dictionary of concatenated operators that acts in
    %               parallel
    %
    %   D = oppDictionary_internal([WEIGHTS],OP1,OP2,...OPn,GATHER) creates a
    ...
    %
    %   D = oppDictionary_internal(N,OP) creates a stacked operator A using N number
    ...
    %
    %   *Note - only spot operators can be used in an oppDictionary_internal, pSpot
    %   operators act in parallel already, and cannot be used with
    %   oppDictionary_internal.
    %
    ...
    methods
        ...
        % Constructor
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        function op = oppDictionary_internal(varargin)
        ...
        function y = double(op)
            %OPPDICTIONARY.DOUBLE Distributed doubling of oppDictionary_internal
            %    A = double(op) will apply double to each child operator
            %    in oppDictionary_internal, and return a distributed dictionary
