...
function dat = setup
   ...
   xr =    iCon.randn(2,2);
   xi = 1i*iCon.randn(2,2);
   dat.A  = A * c;
   dat.B  = B * c;
   dat.x  = xr + xi;
end
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_operator_products(dat)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_opMatrix(dat)
   A = dat.A; B = dat.B; x = dat.x; xr = real(x); xi = imag(x);
   assertElementsAlmostEqual(...
      A * x,...
      B * x);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_transpose(dat) % .' dot-transpose
   A = dat.A; B = dat.B; x = dat.x; xr = real(x); xi = imag(x);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_ctranspose(dat) % ' regular transpose
   A = dat.A; B = dat.B; x = dat.x; xr = real(x); xi = imag(x);
   assertElementsAlmostEqual( ...
      A' * x'  ,...
      B' * x'  );
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_real(dat)
   A = dat.A; B = dat.B; x = dat.x; xr = real(x); xi = imag(x);
   assertElementsAlmostEqual( ...
       real(A)*x   ,...
       real(B)*x   );
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_image(dat)
   A = dat.A; B = dat.B; x = dat.x; xr = real(x); xi = imag(x);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_conj(dat)
   A = dat.A; B = dat.B; x = dat.x; xr = real(x); xi = imag(x);
   c = 1i*iCon.randn;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_pow(dat)
   A = dat.A; B = dat.B; x = dat.x;
   c = iCon.randn(1,1) + sqrt(-1) * iCon.randn(1,1);
   assertElementsAlmostEqual(...
      (A^3) * x,...
      (B^3) * x);
   assertElementsAlmostEqual(...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_inv(dat)
   A = dat.A; B = dat.B; x = dat.x;
   c = iCon.randn(1,1) + sqrt(-1) * iCon.randn(1,1);
   assertElementsAlmostEqual(...
      inv(A) * x,...
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_inv_pow(dat)
   c = iCon.randn(1,1) + 1i * iCon.randn(1,1);
   A = iCon.randn(3,3) + 1i * iCon.randn(3,3);
   x = iCon.randn(3,1) + 1i * iCon.randn(3,1);
   B = opMatrix(A);
   assertElementsAlmostEqual(...
      (A^-3) * x,...
      (B^-3) * x);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mvcoremethods_simplification(dat)
   B = dat.B;
   assertEqual(char(B),...
               char((B')'));
   assertEqual(char(B),...
