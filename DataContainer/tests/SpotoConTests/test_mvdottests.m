function test_suite = test_mvdottests
...
function test_mvdottests_elementary(seed)
...
function test_mvdottest_ensembles(seed) 
   m = randi(100); n = randi(100);
...
function test_mvdottest_fast(seed)
   m = randi(100); n = randi(100);
...
function test_mvdottest_meta(seed)
   m = randi(100); n = randi(100);
   A = opMatrix(iCon.randn(m,n));
   B = opMatrix(iCon.randn(m,n));
